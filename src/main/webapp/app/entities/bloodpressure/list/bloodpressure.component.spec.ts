...
describe('Bloodpressure Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'bloodpressure', component: BloodpressureComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to bloodpressureService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBloodpressureIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBloodpressureIdentifier).toHaveBeenCalledWith(entity);
